...
public class GetGameHistoryPageByUserHandler(IGameSessionRepository gameSessionRepository, IMapper mapper)
    : IRequestHandler<GetGameHistoryPageByUserQuery, PagedResult<FinishedGameDto>>
{
    public async Task<PagedResult<FinishedGameDto>> Handle(GetGameHistoryPageByUserQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var result = new PagedResult<FinishedGameDto>(mappedGames, games.Count(), request.ScoreboardQuery.PageSize,
            request.ScoreboardQuery.PageNumber);
