...
public class GetGameHistoryPageHandler(IGameSessionRepository gameSessionRepository, IMapper mapper)
    : IRequestHandler<GetGameHistoryPageQuery, PagedResult<FinishedGameDto>>
{
    public async Task<PagedResult<FinishedGameDto>> Handle(GetGameHistoryPageQuery request,
