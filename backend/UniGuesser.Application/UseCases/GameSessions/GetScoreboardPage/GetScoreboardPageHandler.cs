...
public class GetScoreboardPageHandler(IGameSessionRepository gameSessionRepository)
    : IRequestHandler<GetScoreboardPageQuery, PagedResult<UserStats>>
{
    public async Task<PagedResult<UserStats>> Handle(GetScoreboardPageQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var result = new PagedResult<UserStats>(pagedGames, games.Count(), request.ScoreboardQuery.PageSize,
