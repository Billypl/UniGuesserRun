...
interface ClassicGameInterfaceProps {
	error: string | null
...
const ClassicGameInterface: React.FC<ClassicGameInterfaceProps> = (props) => {
	...
	return (
		<div className={styles.game_interface}>
			...
			{/* Map Section - Classic mode with manual selection */}
...
export default ClassicGameInterface
