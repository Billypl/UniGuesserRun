...
Przedstawiony na rysunku \ref{fig:erd-diagram} diagram ERD (ang. \textit{Entity-Relationship Diagram}) ilustruje strukturę bazy danych aplikacji UniGuesser, pokazując główne tabele oraz relacje między nimi. Użytkownik może posiadać wiele sesji gier, a każda sesja ma określoną liczbę rund, z których każda posiada przypisaną do siebie lokacje. Ponadto każde miejsce może mieć swojego autora (użytkownika), który dodał je do bazy danych. 
