...
Opis struktury aplikacji po stronie klienta:
	sposób organizacji komponentów,
	podział na moduły (np. ekrany gry, profil użytkownika, ranking),
	podejście do routingu,
	sposób komunikacji z backendem poprzez API.

Możliwy jest dodatek w formie diagramu lub schematu przepływu danych.

\subsection{Struktura UI i komponentów (Karina Wołoszyn)}

Opis implementacji interfejsu:
	główne komponenty (mapa, panel gry, formularze),
	ich logika działania,
	podział na komponenty prezentacyjne i funkcyjne.

Można omówić także mechanizm nawigacji pomiędzy ekranami.
----
