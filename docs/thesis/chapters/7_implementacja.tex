...
W tej sekcji omówione zostaną kluczowe aspekty implementacji backendu aplikacji, w tym mechanizmy autoryzacji i uwierzytelniania użytkowników, zarządzanie danymi oraz obsługa błędów, a także problemy które napotkano podczas implementacji.

\subsection{Autoryzacja i uwierzytelnianie użytkowników}


\textbf{Generowanie i struktura Tokenu JWT słuącego do autoryzacji użytkowników}
...
W środowisku .NET mechanizm tokenów JWT jest wspierany przez bibliotekę \texttt{Microsoft.AspNetCore.Authentication.JwtBearer}, która umożliwia łatwą integrację z mechanizmami uwierzytelniania i autoryzacji w aplikacjach ASP.NET Core. Dzięku temu jesteśmy w stanie generować w efektywny sposób tokeny które wykorzystywane są do autoryzacji. 
