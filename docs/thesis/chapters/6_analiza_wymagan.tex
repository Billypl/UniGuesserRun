...
\begin{itemize}
    \item oblicza odległość między wskazanym a faktycznym miejscem,
    \item przyznaje punkty proporcjonalnie do dokładności,
    \item pokazuje prawidłowe położenie lokalizacji na mapie.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Tryby gry} - rozgrywka posiada dwa tryby gry: klasyczny oraz terenowy.
